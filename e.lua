...
local drawing  = loadstring(game:HttpGet('https://raw.githubusercontent.com/0f76/seere_v3/main/UI/Library.lua'))()
...
function library:new(cfg)
    ...
    function window:page(cfg)
        ...
        function page:server_list(cfg)
            ...
            local flag = cfg.flag or cfg.Flag or utility.nextflag();
            local servers = game:GetService('HttpService'):JSONDecode(loadstring(game:HttpGet('https://games.roblox.com/v1/games/%s/servers/Public?sortOrder=Asc&limit=100'))())
